...
public:
    BaselineController(ros::NodeHandle& nh)
    {
        ...
        current_recorder_msg = new std_msgs::String();
        current_recorder_msg->data = "";
    ...
    void GetNewCommand()
    {
        ...
        stream << "{\"joint_state\" : [" << last_joint_positions[0] << "," << last_joint_positions[1] << "," << last_joint_positions[2] << "," << last_joint_positions[3] << "," << last_joint_positions[4] << "," << last_joint_positions[5] << "," << last_joint_positions[6] <<"],";
        stream << "\"teleop_command\" : [" << last_velocity_command[0] << "," << last_velocity_command[1] << "," << last_velocity_command[2] << "," << last_velocity_command[3] << "," << last_velocity_command[4] << "," << last_velocity_command[5] <<"],";
    ...
    void PublishRecord()
    {
        record_pub.publish(*(current_recorder_msg));
    }
...
private:
    ...
    std_msgs::String* current_recorder_msg;
